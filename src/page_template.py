...
<link rel="canonical" href="https://www.robbinsanalytics.com/cascadia-controltower/">

<!-- Icons and social card. Without these a shared link has nothing to build a
     preview from but <title>, and renders as a generic card — which is what
     happened the first time this URL was sent to someone.

     Both are VENDORED, like echarts.min.js and the chart theme beside them.
     The card is generated by the site repo's tools/build_thumbs.py from a
     single MODULES table, and the icons come from that repo's brand folder;
     the copies here are byte-identical. Referencing them across repos would
     keep one source of truth but leave this page's card and tab icon silently
     dependent on files another repository can rename. A module that serves
     itself should serve all of itself. The cost is a copy that can drift, so
     if build_thumbs.py is re-run for this slug, re-copy the output. -->
     Icons are relative — the browser resolves them against this page. The
     card URL must be absolute: a scraper is not a browser and does not
...
<meta property="og:site_name" content="Robbins Analytics">
<meta property="og:title" content="Cascadia Control Tower — fill-rate governance and the split-shipment leak">
<meta property="og:description" content="Three fill rates from one dataset, why they disagree, and the split cost none of them measures.">
<meta property="og:url" content="https://www.robbinsanalytics.com/cascadia-controltower/">
<meta property="og:image" content="https://www.robbinsanalytics.com/cascadia-controltower/assets/og-controltower.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Cascadia module card — Cascadia Control Tower, fill-rate governance and the split-shipment leak, on synthetic data with BLS, Census and SEC XBRL anchors.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Cascadia Control Tower — fill-rate governance and the split-shipment leak">
<meta name="twitter:description" content="Three fill rates from one dataset, why they disagree, and the split cost none of them measures.">
<meta name="twitter:image" content="https://www.robbinsanalytics.com/cascadia-controltower/assets/og-controltower.png">
<meta name="twitter:image:alt" content="Cascadia module card — Cascadia Control Tower, fill-rate governance and the split-shipment leak.">
